...
> **Prompt** Good awsome now can you generate the image having the UI/screens  for showing the above Notification  App     covering all above actors ,  actions please with professional  based simple UI/UX easy to understand and looking good  , minimal text looking good covering all the screens , prememium professional 
