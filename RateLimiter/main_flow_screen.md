...
> **Prompt** Good awsome now can you generate the image having the UI/screens  for showing the above Rate Limiter App      covering all above actions please with professional  based simple UI/UX easy to understand and looking good  , minimal text looking good covering all the screens , looking good
