...
const navItems = [
  ...
  { to: '/driver/incoming', label: 'Rides', icon: '🚗' },
      ...
      <header className="bg-white border-b border-slate-100 sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-brand text-white grid place-items-center font-bold">D</div>
            <div>
              <p className="text-sm font-semibold leading-tight">Driver App</p>
