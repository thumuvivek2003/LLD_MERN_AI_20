...
const navItems = [
  ...
  {
    label: 'My Borrows', path: '/borrows', icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    label: 'All Borrows', path: '/admin/borrows', icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <aside className="w-64 min-h-screen bg-sidebar flex flex-col">
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm">LibraryMS</p>
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-3 py-2 text-white/60 hover:text-white hover:bg-white/10 rounded-lg text-sm transition"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
